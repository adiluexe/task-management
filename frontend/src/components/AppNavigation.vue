<template>
  <nav class="bg-white/90 backdrop-blur-lg border-b border-background-100 sticky top-0 z-50">
    <div class="w-full px-4 sm:px-6 lg:px-8">
      <div class="flex items-center justify-between h-16 w-full">
        ...
        <!-- Right Side Menu -->
        <div class="hidden sm:flex sm:items-center space-x-3 lg:space-x-4 xl:space-x-6">
          <!-- Navigation Links -->
          <router-link
            to="/"
            class="nav-item"
          ...
          <div class="relative" ref="userMenuRef">
            ...
            >
              ...
              <Icon icon="lucide:chevron-down" class="w-4 h-4 text-text-400 transition-transform group-hover:text-text-600" :class="{ 'rotate-180': userMenuOpen }" />
            </button>
            ...
            <Transition name="dropdown">
              ...
              >
                <div class="px-4 py-3 border-b border-background-100">
                  ...
                  <p class="text-xs text-text-600">{{ authStore.user?.email }}</p>
                </div>
                <button
                  @click="handleLogout"
