  ...
  <div class="min-h-screen bg-gray-50">
    <div class="max-w-7xl mx-auto py-6 sm:px-6 lg:px-8">
      ...
      <div class="mb-8">
        ...
        <p class="mt-2 text-sm text-gray-600">Welcome back! Here's an overview of your tasks.</p>
      </div>
            ...
            <div class="flex items-center">
              ...
              <div class="ml-5 w-0 flex-1">
                <dl>
                  ...
                  <dd class="text-lg font-medium text-gray-900">{{ taskStore.taskStats.total }}</dd>
                </dl>
              </div>
            </div>
          </div>
            ...
            <div class="flex items-center">
              ...
              <div class="ml-5 w-0 flex-1">
                <dl>
                  ...
                  <dd class="text-lg font-medium text-gray-900">{{ taskStore.taskStats.completed }}</dd>
                </dl>
              </div>
            </div>
          </div>
            ...
            <div class="flex items-center">
              ...
              <div class="ml-5 w-0 flex-1">
                <dl>
                  ...
                  <dd class="text-lg font-medium text-gray-900">{{ taskStore.taskStats.pending }}</dd>
                </dl>
              </div>
            </div>
          </div>
